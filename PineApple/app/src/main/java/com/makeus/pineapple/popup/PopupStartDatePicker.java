    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_no.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //필터UI의 날짜 변경
                //년월
                PopupFilter.tv_start_year_month.setText("시작날짜");
                //일
                PopupFilter.tv_start_days.setText("00");
                //요일
                PopupFilter.tv_start_day.setText(null); //요일 계산하기

                Fragment1_Home.startDate = null; //yyyy-MM-dd 형식으로 저장했음
