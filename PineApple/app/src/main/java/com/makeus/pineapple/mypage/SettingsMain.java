...
public class SettingsMain extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_settings_main, container, false);
        ...
        fl_btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myContext.getSupportFragmentManager().beginTransaction().replace(R.id.container_fragment,fragment_mypage).commit();//프래그먼트 전환
        ...
        fl_btn_profile_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myContext.getSupportFragmentManager().beginTransaction().replace(R.id.container_fragment,fragment_profile_edit).commit();//프래그먼트 전환
        ...
        fl_btn_letter_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myContext.getSupportFragmentManager().beginTransaction().replace(R.id.container_fragment,fragment_edit_letter).commit();//프래그먼트 전환
