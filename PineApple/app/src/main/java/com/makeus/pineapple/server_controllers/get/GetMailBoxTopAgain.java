...
//레터 정보 불러오는 클래스
public class GetMailBoxTopAgain implements GetMailboxInterface {
    Context myContext;
    RecyclerView rv_top;
    ...
    public GetMailBoxTopAgain(Context myContext, RecyclerView rv_top, HomeAdapters homeAdapters) {
