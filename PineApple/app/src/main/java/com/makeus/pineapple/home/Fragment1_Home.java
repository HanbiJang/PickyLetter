...
/*        intent.putExtra("data", "Test Popup");
        ...
        newLetterAdapter.addItem(new NewLetter("페이스북,인스타그램,유튜브의 잘못된 UI","디독","02/01/2021",R.drawable.news_6,R.drawable.brand_1));
        newLetterAdapter.addItem(new NewLetter("주목받는 재택근무 관련주와 라이프스타일의 변화 \uD83D\uDC69\u200D\uD83D\uDCBB\n","어피티","02/01/2021",R.drawable.news_7,R.drawable.brand_3));
        newLetterAdapter.addItem(new NewLetter("비상 걸린 콜센터,원격 콜센터 구축 업체는? \uD83D\uDCDE","어피티","02/01/2021",R.drawable.news_8,R.drawable.brand_3));
