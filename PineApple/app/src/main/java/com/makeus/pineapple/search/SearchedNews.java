...
public class SearchedNews {
    ...
    public SearchedNews(Integer viewType, String title, String brand, String date,Integer img_news, Integer img_brand, Boolean isBookmarkClicked) {
        //검색 결과 나타내는 분
    ...
    public SearchedNews(Integer viewType, String title, String brand, String date, Integer numRank,Integer img_news, Integer img_brand, Boolean isBookmarkClicked) {
        this.viewType = viewType;
        this.title = title;
        this.brand = brand;
        this.date = date;
